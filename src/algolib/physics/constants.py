...
hbar = PhysConst(
    1.054571817e-34, "J s", 0.0, "CODATA 2022", "ħ"
)  # derived as h / (2π); exact by definition
R = PhysConst(
    8.314462618, "J mol^-1 K^-1", 0.0, "CODATA 2022", "R"
)  # R = N_A * k_B (exact by definition)
...
m_u = PhysConst(
    1.66053906892e-27, "kg", 3.1e-10, "CODATA 2022", "m_u"
)  # defined as 1/12 of the mass of a 12C atom (not exact after 2019 SI)
