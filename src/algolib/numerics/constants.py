...
- No imports from :mod:`math` or third-party libs: pure Python floats only.
...
LN2 = (
    6.9314718055994530941723212145817656807550013436025525412068000949339362196969472e-1
)
...
INV_LN10 = (
    4.3429448190325182765112891891660508229439700580366656611445378316586464920887077e-1
)
SQRT2 = (
    1.4142135623730950488016887242096980785696718753769480731766797379907324784621070
)
INV_SQRT2 = (
    7.0710678118654752440084436210484903928483593768847403658833986899536623923105352e-1
)
